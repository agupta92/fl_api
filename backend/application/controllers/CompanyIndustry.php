<?php
    class CompanyIndustry extends CI_Controller {
		
        public function __construct()
        {
            parent::__construct();
            $this->load->model('Company_industry_model','',TRUE);
        ...
        public function getAssocJd($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model->get_assoc_jd($getCompany);
        ...
        public function getAssocSkills($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model->get_assoc_skills($getCompany);
        ...
        public function getAssocIndustries($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model->get_assoc_industries($getCompany);
		...
		public function getSimilarCompanies($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model->get_similar_companies($getCompany);
		...
		public function getInThere($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model->get_in_there($getCompany);
		...
		public function getAvailableSalaries($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model->get_available_salaries($getCompany);
		...
		public function getAttritionRate($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model-> get_attritionRate($getCompany);
		...
		public function getPopularSwitchesFromCompany($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model-> get_Popular_Switches_FromCompany($getCompany);
		...
		public function getPopularSwitchesToCompany($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_industry_model-> get_Popular_Switches_ToCompany($getCompany);
