<?php
    class CompanyJdIndustry extends CI_Controller {
		
        public function __construct()
        {
            parent::__construct();
            $this->load->model('Company_jd_industry_model','',TRUE);
			...
			'getSimilarCompanies'=>array('COMPANY','JD'),'getLateralVsHigher'=>array('COMPANY','JD'),'getPopularSwitchesFromCompanySpiderTool'=>array('COMPANY','JD'),
			'getHowToGetInThere'=>array('COMPANY','JD'),'getAvgRateOfStay'=>array('COMPANY','JD'),
			'getAvailableSalaries'=>array('COMPANY','JD'),'getAssocCompanies'=>array('COMPANY','JD'),
        ...
        public function getAssocIndustries($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model->get_assoc_industries($getCompany);
        ...
        public function getAssocSkills($getCompany , $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model->get_assoc_skills($getCompany, $getJd);
		...
		public function getSimilarCompanies($getCompany , $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model->get_similar_companies($getCompany , $getJd);
		...
		public function getAssocCompanies($getCompany , $getJd){
			$this->load->library('utility');
			$memcached =$this->utility->createContentCache();
			$result = $memcached->get('getAssocCompanies'.$getCompany.'-'.$getJd );
			if($result) {					
				echo json_encode($result);
				} else {
				$data['query'] = $this->Company_jd_industry_model->get_similar_companies($getCompany , $getJd);
				$memcached->set('getAssocCompanies'.$getCompany.'-'.$getJd ,$data['query']);
				header('Content-Type: application/json');
				echo json_encode($data['query'],JSON_NUMERIC_CHECK);
			}
		}
		...
		public function getHowToGetInThere($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model->get_howToGetInThere($getCompany, $getJd);
		...
		public function getAvailableSalaries($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model->get_available_salaries($getCompany, $getJd);
		...
		public function getAvgRateOfStay($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model-> get_avg_rate_of_stay($getCompany, $getJd);
		...
		public function getPopularSwitchesFromCompany($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model-> get_Popular_Switches_FromCompany($getCompany, $getJd);
		...
		public function getPopularSwitchesToCompany($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_industry_model-> get_Popular_Switches_ToCompany($getCompany, $getJd);
		...
		public function getLateralVsHigher($getCompany, $getJd) {
			...
			if($result) {					
				...
				$data['query'] = $this -> Company_jd_industry_model -> get_Lateral_Vs_Higher($getCompany, $getJd);
		...
		public function getPopularSwitchesFromCompanySpiderTool($getCompany, $getJd) {
			...
			if($result) {					
				...
				$data['query'] = $this -> Company_jd_industry_model -> get_Popular_Switches_FromCompany_forSpiderTool($getCompany, $getJd);
