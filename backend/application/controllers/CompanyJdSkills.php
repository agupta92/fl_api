<?php
    class CompanyJdSkills extends CI_Controller {
		
        public function __construct()
        {
            parent::__construct();
            $this->load->model('Company_jd_skills_model','',TRUE);
			...
			'getAssocJd'=>array('COMPANY','SKILLS'),'getSimilarCompanies'=>array('COMPANY','JD'),
			'getHowToGetInThere'=>array('COMPANY','JD'),'getAssocCompanies'=>array('COMPANY','SKILLS'),
			'getAvailableSalaries'=>array('COMPANY','JD'),'getAvgRateOfStay'=>array('COMPANY','JD'),
			'getPopularSwitchesFromCompany'=>array('COMPANY','JD'),'getPopularSwitchesToCompany'=>array('COMPANY','JD'),'getLateralVsHigher'=>array('COMPANY','JD'),'getPopularSwitchesFromCompanySpiderTool'=>array('COMPANY','JD'));
            $all_params='';
        ...
        public function getAssocIndustries($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model->get_assoc_industries($getCompany);
        ...
        public function getAssocSkills($getCompany , $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model->get_assoc_skills($getCompany, $getJd);
		...
		public function getSimilarCompanies($getCompany , $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model->get_similar_companies($getCompany , $getJd);
		...
		public function getHowToGetInThere($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model->get_howToGetInThere($getCompany, $getJd);
		...
		public function getAvailableSalaries($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model->get_available_salaries($getCompany, $getJd);
		...
		public function getAvgRateOfStay($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model-> get_avg_rate_of_stay($getCompany, $getJd);
		...
		public function getPopularSwitchesFromCompany($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model-> get_Popular_Switches_FromCompany($getCompany, $getJd);
		...
		public function getPopularSwitchesToCompany($getCompany, $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model-> get_Popular_Switches_ToCompany($getCompany, $getJd);
		...
		public function getLateralVsHigher($getCompany , $getJd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model->lateral_switch_vs_higher($getCompany , $getJd);
		...
		public function getPopularSwitchesFromCompanySpiderTool($getCompany, $getjd){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_jd_skills_model-> get_Popular_Switches_FromCompany_forSpiderTool($getCompany, $getjd);
