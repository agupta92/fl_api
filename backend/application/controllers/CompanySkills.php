<?php
    class CompanySkills extends CI_Controller {
		
        public function __construct()
        {
            parent::__construct();
            $this->load->model('Company_skills_model','',TRUE);
			...
			'getAssocJd'=>array('COMPANY','SKILLS'),'getSimilarCompanies'=>array('COMPANY'),
			'getInThere'=>array('COMPANY','SKILLS'),'getPopularSwitchesFromCompanySpiderTool'=>array('COMPANY','SKILLS'),
			'getAvailableSalaries'=>array('COMPANY','SKILLS'),'getAttritionRate'=>array('COMPANY'),
        ...
        public function getAssocIndustries($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model->get_assoc_industries($getCompany);
        ...
        public function getAssocSkills($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model->get_assoc_skills($getCompany);
		...
		public function getAssocJd($getCompany, $getSkills){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model->get_assoc_jd($getCompany, $getSkills);
		...
		public function getSimilarCompanies($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model->get_similar_companies($getCompany);
		...
		public function getInThere($getCompany, $getSkills){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model->get_in_there($getCompany, $getSkills);
		...
		public function getAvailableSalaries($getCompany, $getSkills){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model->get_available_salaries($getCompany, $getSkills);
		...
		public function getAttritionRate($getCompany){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model-> get_attrition_rate($getCompany);
		...
		public function getPopularSwitchesFromCompany($getCompany, $getSkills){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model-> get_Popular_Switches_FromCompany($getCompany, $getSkills);
		...
		public function getPopularSwitchesToCompany($getCompany, $getSkills){
			...
			if($result) {					
				...
				$data['query'] = $this->Company_skills_model-> get_Popular_Switches_ToCompany($getCompany, $getSkills);
		...
		public function getPopularSwitchesFromCompanySpiderTool($getCompany, $getSkills) {
			...
			if($result) {					
				...
				$data['query'] = $this -> Company_skills_model -> get_Popular_Switches_FromCompany_forSpiderTool($getCompany, $getSkills);
