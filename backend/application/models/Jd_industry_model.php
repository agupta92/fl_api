<?php
    class Jd_industry_model extends CI_Model {
		...
		public function get_assoc_skills($getJD, $industry)
            {
                $sql= "Select skill_token as skill, count(*) as freq  from search_pro where JD='".urldecode($getJD)."' and stan_industry='".urldecode($industry)."' group by 1 order by 2 DESC LIMIT 10";
                $query = $this->db->query($sql);
				$count = $query->num_rows();				
                if($count==0)
                {
		...
		public function get_assoc_company($getJD, $industry)
            {
                $sql= "Select stan_company as company, count(*) as freq  from search_pro where JD='".urldecode($getJD)."' and stan_industry='".urldecode($industry)."' group by 1 order by 2 DESC LIMIT 20";			
                $query = $this->db->query($sql);
				$count = $query->num_rows();				
                if($count==0)
                {
